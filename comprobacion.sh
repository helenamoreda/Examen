...
if [ -s /root/.jvscripts/hardware/PID.txt ];
	then
		if [ "$PID1" != "$PID2" ];
			...
			sendemail -f helena1094@hotmail.com -t helena1094@gmail.com -s smtp.live.com -u \ "Script parado" -m "El script mysql-alumno2.sh ha dejado de funcionar en el equipo $hostname" -v -xu helena1094@hotmail.com -xp nightmare1 -o tls=yes
		fi
	else
		sendemail -f helena1094@hotmail.com -t helena1094@gmail.com -s smtp.live.com -u \ "Script parado" -m "El script mysql-alumno2.sh ha dejado de funcionar en el equipo $hostname" -v -xu helena1094@hotmail.com -xp nightmare1 -o tls=yes
fi
