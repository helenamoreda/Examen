...
# script que arranca, para, relanza y nos muestra el estado de 'apliaciones.sh'
...
DESCRIPCIÓN
    Muestra que arranca, para, relanza y nos muestra el estado de 'aplicaciones.sh'.
